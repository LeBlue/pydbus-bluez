...
SERVICES = {
   gap['uuid']: gap,
   device_information['uuid']: device_information
}
...
class FormatCRF(fmt.FormatTuple):
   sub_cls = (fmt.FormatUint8Enum, fmt.FormatSint8, fmt.FormatUint16, fmt.FormatUint8Enum, fmt.FormatUtf8s)
